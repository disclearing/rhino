...
public class TimerManager implements Listener{
	...
	public final KEYSALETimer keySaleTimer;
	public final SALETimer saleTimer;
	public final KEYALLTimer keyAllTimer;
	...
	public TimerManager(HCF plugin){
		...
		this.keySaleTimer = new KEYSALETimer();
		this.registerTimer(this.keySaleTimer);
		this.saleTimer = new SALETimer();
		...
		this.keyAllTimer = new KEYALLTimer();
		this.registerTimer(this.keyAllTimer);
